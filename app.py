...
- บอกว่าเมนส์มาแล้ว / มาแล้ว / มาวันนี้ → {"action": "start_period", "date": "YYYY-MM-DD"}
  วันที่ใน date คือวันแรกที่เมนส์มา คำนวณให้ถูกต้องตามนี้
  - "มาวันนี้" หรือไม่ระบุ → date = วันนี้
  - "มาเมื่อวาน" → date = เมื่อวาน (1 วันก่อน)
  - "มาสองวันแล้ว" หรือ "มาได้ 2 วัน" → date = 2 วันก่อน
  - "เมื่อวานเป็นวันที่สอง" → แปลว่าวันแรกคือ 2 วันก่อน date = 2 วันก่อน
  - "วันนี้เป็นวันที่สาม" → แปลว่าวันแรกคือ 3 วันก่อน date = 3 วันก่อน
  - "มาตั้งแต่วันที่ 20" → date = วันที่ 20 เดือนปัจจุบัน
  สำคัญมาก: date ต้องเป็นวันแรกที่เมนส์มาเสมอ ไม่ใช่วันที่ user พูดถึง
...
- บอกว่าแฟนเมนส์มาแล้ว → {"action": "start_period", "date": "YYYY-MM-DD"}
  ...
  - "วันนี้เป็นวันที่สาม" → แปลว่าวันแรกคือ 3 วันก่อน date = 3 วันก่อน
  - "มาตั้งแต่วันที่ 20" → date = วันที่ 20 เดือนปัจจุบัน
  สำคัญมาก: date ต้องเป็นวันแรกที่เมนส์มาเสมอ
